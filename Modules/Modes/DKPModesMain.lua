  ...
  ---
    ...
    ---
      ...
      ---
        ...
        f.DKPModesMain.RollContainer.maxKarma = CreateFrame("EditBox", nil, f.DKPModesMain.RollContainer)
        ...
        f.DKPModesMain.RollContainer.maxKarma.Header:SetText("Max DKP to add"..": ")
